...
const char *WINDOWTITLE = { "OpenGL / GLUT Sample -- ESSAM FIAZ - Project 4" };
...
Display( )
{
	...
	//glShadeModel(GL_FLAT);
		...
		texture = BmpToTexture("image.bmp", &texWidth, &texHeight);
	...
	glLoadIdentity( );
	glColor3f( 1., 1., 1. );
	DoRasterString( 5., 5., 0., "ESSAM FIAZ - Project 4" );
