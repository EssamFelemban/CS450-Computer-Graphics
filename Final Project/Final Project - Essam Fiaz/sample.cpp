...
void background()
{
    ...
    bool played = PlaySound("epic.wav", NULL, SND_ASYNC | SND_LOOP);
...
void display()
{
    char pr[20] = "final project";
    char name[20] = "ESSAM FIAZ ";
...
int main(int argc, char** argv)
{
    ...
    glutCreateWindow("Final project: ISSAM FIAZ");
